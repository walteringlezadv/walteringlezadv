...
const article: Article = {
  slug: "ccb-original-execucao-stj-maio-2026",
  title: "STJ afasta exigência automática do original da CCB em execução bancária",
  description: "Decisão do STJ sobre CCB reforça que objeções genéricas não bastam para barrar execução bancária em processo eletrônico.",
  excerpt: "A Quarta Turma do STJ decidiu que a via original da CCB não é requisito automático da execução. O ponto central é a qualidade da leitura técnica do caso.",
  ...
  category: "CCB",
  tags: ["CCB", "execução bancária", "processo eletrônico", "garantias"],
  readingTime: 5,
  body: (
    <>
      <p>
      ...
      <h2>Contexto jurídico ou de mercado</h2>
      ...
      <h2>O que o empresário precisa entender</h2>
      ...
      <h2>Risco de não entender ou agir errado</h2>
      ...
      <p>
        <strong>O problema não é apenas existir uma execução bancária; o risco maior é decidir no escuro, sem compreender se a CCB, a planilha e as garantias formam um conjunto realmente executável ou se há pontos técnicos capazes de alterar a estratégia.</strong>
      </p>

      <h2>Referência</h2>

      <p>
        Superior Tribunal de Justiça. <a href="https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias/2026/30032026-Quarta-Turma-afasta-exigencia-de-original-de-cedula-de-credito-bancario-na-execucao.aspx" target="_blank" rel="noopener noreferrer">Quarta Turma afasta exigência de original de cédula de crédito bancário na execução</a>. Notícia publicada em 30 de março de 2026, referente ao REsp 2.015.911-DF.
      </p>
  ...
  seo: {
    title: "STJ afasta exigência automática do original da CCB — Walter Inglez",
    description: "Decisão do STJ sobre CCB reforça que objeções genéricas não bastam para barrar execução bancária em processo eletrônico.",
  },
};
