---
title: "Cessão de crédito bancário a FIDC: o que muda na cobrança da empresa"
excerpt: "Quando o banco vende a dívida, o empresário enfrenta novo credor. STJ valida manutenção de juros e fiança na cessão a FIDC. Entenda o que muda."
publishedAt: "2026-06-19"
category: "Contratos Bancários"
tags: ["cessão de crédito bancário", "banco vendeu minha dívida para um FIDC", "o que muda quando o banco cede a dívida para cobrança", "fiança continua válida após cessão de crédito a fundo", "cobrança de empresa terceirizada"]
seo:
  title: "Cessão de crédito bancário a FIDC: o que muda na cobrança"
...
| Fator de Análise | Banco de Origem | FIDC / Cessionário |
|------------------|-----------------|--------------------|
| **Foco da cobrança** | Manutenção do relacionamento e balanço contábil | Recuperação acelerada do valor investido na compra da carteira |
| **Encargos** | Juros originais da CCB ou contrato | Juros originais mantidos (STJ REsp 1.984.424/SP) |
| **Garantias pessoais** | Fiança e aval ativos | Fiança e aval transferidos e válidos (STJ REsp 1.726.161/SP) |
| **Margem de negociação** | Sujeita a políticas internas padronizadas | Variável conforme o deságio da compra do crédito, mas com execução agressiva |
...
[Lei nº 10.406, de 10 de Janeiro de 2002 — Planalto](https://www.planalto.gov.br/ccivil_03/leis/2002/l10406compilada.htm)
[REsp 1.726.161/SP, Rel. Min. Luis Felipe Salomão, 4ª Turma — STJ](https://www.stj.jus.br/websecstj/cgi/revista/REJ.cgi/ITA?seq=1847231&tipo=0&nreg=201800412510&dt=20190903&formato=PDF)
[REsp 1.984.424/SP, Rel. Min. Ricardo Villas Bôas Cueva, 3ª Turma — STJ](https://www.stj.jus.br/sites/portalp/Paginas/Comunicacao/Noticias/2022/02092022-Devem-ser-mantidos-os-encargos-de-credito-cedido-a-nao-integrante-do-Sistema-Financeiro-Nacional.aspx)
